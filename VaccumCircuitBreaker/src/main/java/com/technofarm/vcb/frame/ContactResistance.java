 ...
 * @author HP
 */
public class ContactResistance extends javax.swing.JFrame implements Runnable{
...
//    Connection con;
    ...
    Object inputArray[];
    int min[], max[];
    public ContactResistance() {
        initComponents();
        //this init is to keep same code
        jLabel47 = jLabel49;
        getComPorts();
        openPort();
        createFile();
    ...
    private void initComponents() {
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel11Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jLabel97, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel1.setText("Applied DC Current");
        ...
        jLabel3.setText("Main Contact Drop");
        ...
        jLabel4.setText("Main Contact Resistance");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContactResistance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
