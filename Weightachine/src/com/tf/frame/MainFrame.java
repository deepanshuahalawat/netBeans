...
public class MainFrame extends javax.swing.JFrame {
 ...
 public static void createFile() {
        String path="C:\\ProgramData\\Industrial Engineering\\TDRRelay";
        File f = new File("C:\\ProgramData\\Industrial Engineering\\TDRRelay");
        File txtFile = new File(f, "/NewRelayStandardValues.txt");
        if (!f.exists() || !txtFile.exists()) {
            System.out.println("Making file at: " + f.mkdirs());
            File f1 = new File(f, "/NewRelayStandardValues.txt");
            try {
                f1.createNewFile();
                String headrow = "Date\tLoco No.\tRelay Serial No.\tNo. Of Cycles \t"
                        + "Test Voltage(volts) \t"
                        + "On Time (second) \t"
                        + "Off Time (second) \t"
                        + "C1 (mv)\t"
                        ...
                        + "C5 (mv)\t"
                        + "C7 (mv)\t"
                        + "Coil Resistance(K Ohm)\t";
                //ExcelUtilities.createExcel(path,"Record", headrow);
            } catch (Exception e) {
                System.out.println("Error in creating file in DI  " + e);
            }
        }
 ...
 public EntryVO getDataRow(){
        ...
        entryVO.setAmount(entryVO.getRate() * entryVO.getWeight());
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addComponent(amountTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jButton5.setBackground(new java.awt.Color(199, 6, 6));
        jButton5.setFont(new java.awt.Font("Simplified Arabic Fixed", 0, 24)); // NOI18N
        ...
        jButton4.setFont(new java.awt.Font("Simplified Arabic Fixed", 0, 24)); // NOI18N
        ...
        jButton1.setBackground(new java.awt.Color(34, 195, 34));
